...
Each folder holds `paper.txt` (pdftotext extraction), `summary.md`, `meta.json`, and where available the TeX source. The synthesis is in `report/SURVEY.md`; the questions it answers are in `report/QUESTIONS.md`.
