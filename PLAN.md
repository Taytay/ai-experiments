...
| 27 | Prompt distillation v2 (after REPORT.md 14): teacher distribution renormalised over the option set, or a teacher with the options listed and scored by letter, at temperature 1; arm P's mixture and budget. Success: bare recall above arm C's 20.6 with the ICL suite held. | BASE-3 | 7 | todo | |
