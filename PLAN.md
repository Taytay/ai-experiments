...
| 24 | Perplexity on a held-out corpus slice (a few thousand tokens of WikiText-2 test) in place of the single general paragraph; re-score the saved adapters so every arm has the number. | TRAIN-3 | 11 | todo | |
