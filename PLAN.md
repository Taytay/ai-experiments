...
| 25 | General-text replay: add a few percent of pretraining-style text to arm C's mix and re-run with `PERIODIC=200`; does `K_arc_easy` hold at 73.5 the way ICL replay holds the ICL suite? | TRAIN-7 | 11 | todo | |
