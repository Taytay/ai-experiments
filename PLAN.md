...
| 6 | Report fixes that need no run: caveat the held-out-partition claim in the summary; rename "RAG ceiling" to "oracle context"; disclose the arm D schedule confound and token-weighted mixture fractions in the design table. | REPORT-1, REPORT-3, REPORT-4 | - | todo | |
