...
COLS = [("base", "curriculum_Qwen2.5-3B_base", "base"), ("A (knowledge)", "curriculum_Qwen2.5-3B_A_p200", "trained"), ("C (mixture)", "curriculum_Qwen2.5-3B_C_p200", "trained"),
        ...
        ("MEMIT all, ridge 15", "curriculum_edit_memit_all_ridge15_qwen2.5-3b_base", "base"), ("AlphaEdit all", "curriculum_edit_alphaedit_all_qwen2.5-3b_base", "base")]
EDITS = {"MEMIT type": "edit_memit_type", "MEMIT type, ridge 150": "edit_memit_type_ridge150", "MEMIT type, ridge 15": "edit_memit_type_ridge15", "AlphaEdit type": "edit_alphaedit_type", "MEMIT all, ridge 15": "edit_memit_all_ridge15", "AlphaEdit all": "edit_alphaedit_all"}
