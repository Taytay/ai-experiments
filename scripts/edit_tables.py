...
COLS = [("base", "curriculum_Qwen2.5-3B_base", "base"), ("A (knowledge)", "curriculum_Qwen2.5-3B_A_p200", "trained"), ("C (mixture)", "curriculum_Qwen2.5-3B_C_p200", "trained"),
        ...
        ("MEMIT all record relation-first, ridge 15", "curriculum_edit_memit_allyaml_ridge15_qwen2.5-3b_base", "base")]
EDITS = {"MEMIT type": "edit_memit_type", "MEMIT type, ridge 150": "edit_memit_type_ridge150", "MEMIT type, ridge 15": "edit_memit_type_ridge15", "AlphaEdit type": "edit_alphaedit_type", "MEMIT all relation-first, ridge 15": "edit_memit_allpre_ridge15", "AlphaEdit all": "edit_alphaedit_all", "MEMIT all record relation-first, ridge 15": "edit_memit_allyaml_ridge15"}
